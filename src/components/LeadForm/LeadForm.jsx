            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="lead__form" noValidate>
                <div className="lead__field">
                  ...
                  />
                  {errors.name && <span className="lead__error">{errors.name.message}</span>}
                </div>
                ...
                <div className="lead__field">
                  ...
                  />
                  {errors.mobile && <span className="lead__error">{errors.mobile.message}</span>}
                </div>
                ...
                <div className="lead__field">
                  ...
                  {errors.business && <span className="lead__error">{errors.business.message}</span>}
                </div>
